...
// import ExpressionLanguage from '../../../../expression-language/src/index';
// import ExpressionLanguage from '@lib/expression-language/src/index'
import sprintf from 'locutus/php/strings/sprintf';

// console.log('ExpressionLanguage: ',ExpressionLanguage);

export abstract class AbstractRecursivePass implements CompilerPass
{
    /**
     * @var ContainerBuilder
     */
    protected container: ContainerBuilder = null as any;
    protected currentId: string = null as any;

    private processExpressions = false;
    // private expressionLanguage: ExpressionLanguage = null as any;
    private _inExpression = false;
    ...
    protected  inExpression(reset = true): boolean
    {
